...
# （已废止）AI 生成与卡片交互合约冻结清单

> 版本：0.4（历史）
> 日期：2026-09-04
> 状态：**已被 PRD v0.6 与全流程功能清单替代，仅保留作历史记录**
> 当前权威文档：[AI 学习闭环全流程功能清单](../../AI学习闭环-全流程功能清单.md) · [AI 错题卡学习闭环 PRD](../../AI生成练习卡-PRD.md)

本文件记录 2026-09-04 版本的历史决策，不再是实现依据。其中“外部设置窗”“页面级 Agent 动作”“新对话清空任务”等结论与当前设计冲突，禁止继续据此开发。当前实现与验收一律以 PRD v0.6 和全流程功能清单为准。
