...
> 2026-09-05 工程补充：已按[错题整理与错因复习方案](./错题整理与错因复习-重设计方案.md)实现首批流程；生成请求新增 recall 模式，旧 similar 模式兼容保留。具体通过记录与剩余范围见[执行记录](./项目升级执行记录.md)。

# 知拾 AI 学习闭环：全流程功能清单

> 2026-09-05 升级修订提示：以[升级计划书 C01～C05](./项目升级从需求到落地计划书.md)记录的用户决定约束本轮新增实现。AGT-001/008、DSP-007、PRAC-004 等入口与批准规则，以及全类型编辑和联网搜索能力的差异见[原型对照说明](./demo/learning-flow-upgrade/README.md)。本清单尚未完成统一改版；保留已有 ID，冲突项按已确认决定修订，未受影响的数据与安全约束继续保留。原型交互和正式能力均不得仅凭文档标为通过。
